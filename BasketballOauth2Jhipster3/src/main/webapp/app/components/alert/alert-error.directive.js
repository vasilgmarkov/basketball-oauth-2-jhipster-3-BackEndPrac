(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('basketballOauth2Jhipster3App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-basketballOauth2Jhipster3App-error');
                var entityKey = httpResponse.headers('X-basketballOauth2Jhipster3App-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('basketballOauth2Jhipster3App.' + fieldError.objectName + '.' + convertedField);
